...
var crudanswers = __webpack_require__(101);

var questions = new Vue({
    el: '#questions',
    components: {
        crudanswers: crudanswers
    },
    data: function data() {
        return {
            questionTypeId: null,
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'crudanswers',
    props: ['inputAnswer', 'inputAnswerType', 'returnedData', 'questionTypeId', 'questionId'],
    data: function data() {
        var _ref;
        ...
        return _ref = {
            ...
            answers: [],
            answerTypes: []
        }, _defineProperty(_ref, 'answerTypes', []), _defineProperty(_ref, 'questions', []), _defineProperty(_ref, 'updatingAnswer', {}), _defineProperty(_ref, 'selectedQuestionTypeId', null), _defineProperty(_ref, 'singleNextQuestion', null), _ref;
    },
    ...
    methods: {
        ...
        getAnswerTypes: function getAnswerTypes(id) {
            var x = this;
            if (id !== null) {
                axios.get('/admin/list-answer-types/' + id).then(function (response) {
        ...
        getQuestion: function getQuestion(id) {
            ...
            axios.get('/admin/question-by-id/' + id).then(function () {
        ...
        getAnswerType: function getAnswerType(id) {
            var result = void 0;
            axios.get('/api/get_answer_type/' + id).then(function (response) {
        ...
        answerTypeById: function answerTypeById(id) {
        ...
        nextQuestionById: function nextQuestionById(id) {
  ...
  return _c("div", { staticClass: "border" }, [
            ...
            return _c("tr", { key: index, staticClass: "d-flex" }, [
              _c("td", { staticClass: "col-md-4" }, [
                ...
                _c("input", {
                  ...
                  domProps: { value: answer.answerId }
                }),
                _vm._v(" "),
                _c("input", {
                  attrs: {
                    type: "hidden",
                    name: "answers[" + index + "][answer_question_id]"
                  },
                  domProps: { value: answer.answerQuestionId }
                })
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "col-md-2" }, [
                ...
                _c("input", {
                  attrs: {
                    type: "hidden",
                    name: "answers[" + index + "][answer_type_id]"
                  },
                  domProps: { value: answer.answerTypeId }
                }),
                _vm._v(" "),
                _c("input", {
                  attrs: {
              ...
              _c("td", { staticClass: "col-md-5" }, [
                ...
                _c("input", {
                  ...
                  domProps: { value: answer.nextQuestionId }
                }),
                _vm._v(" "),
                _c("input", {
                  attrs: {
    ...
    _c("div", { staticClass: "row d-flex" }, [
      _c(
        "div",
        {
          class: { "col-md-4 pr-0": true, " has-error": _vm.inputAnswerError }
        },
        [
          _c("input", {
            directives: [
        ...
        [
          _c(
            ...
            _vm._l(_vm.answerTypes.data, function(answerType, index) {
              return _c(
                "option",
                { key: index, domProps: { value: answerType.id } },
      ...
      _c("div", { staticClass: "col-md-5 p-0" }, [
        _c(
          ...
          [
            _c(
              "option",
              { attrs: { selected: "selected" }, domProps: { value: -1 } },
            ...
            _vm._l(_vm.questions.data, function(question, index) {
              return _c(
                "option",
                { key: index, domProps: { value: question.id } },
  ...
  function() {
    ...
    return _c("thead", { staticClass: "thead-light" }, [
      _c("tr", { staticClass: "d-flex" }, [
        _c("th", { staticClass: "col-md-4" }, [_vm._v("Answer")]),
        _vm._v(" "),
        _c("th", { staticClass: "col-md-2" }, [_vm._v("Type")]),
        _vm._v(" "),
        _c("th", { staticClass: "col-md-5" }, [_vm._v("Next Question")]),
        _vm._v(" "),
